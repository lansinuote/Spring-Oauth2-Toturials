...
public class testClient1 {
    ...
    public void getTokenByCode() throws IOException {
        ...
        String[] params = new String[]{
                ...
                "code", "6FnG6s",//这个code是从getCode()方法获取的
    ...
    public void checkToken() throws IOException {
        String[] params = new String[]{
                "token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOlsicmVzb3VyY2UxIl0sInVzZXJfbmFtZSI6ImFkbWluIiwic2NvcGUiOlsic2NvcGUxIl0sImV4cCI6MTYxNDA5MjE1MiwiYXV0aG9yaXRpZXMiOlsiYWRtaW4iXSwianRpIjoiNzM0ZWNiNGItZmMyOC00ZmNkLThkN2QtNjBhZTE3YWJhOGI0IiwiY2xpZW50X2lkIjoiY2xpZW50MSJ9.YsGNyTusTrYgqfd9GPTyVqq4Jw0foGobCvIeGKmTftI",
        };
